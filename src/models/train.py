...
def train(cfg: DictConfig) -> None:
    ...
    # Fix feature names: replace spaces with underscores to avoid LightGBM warnings
    # and ensure consistency between fit and transform
    ...
    setup(
        ...
        log_experiment=False,  # Disable PyCaret's MLflow logging to avoid compatibility issues
        log_plots=False  # We'll handle logging manually
    )
    ...
    # Change to plots directory temporarily to save plots there
    import os
